...
public class pendingProjectAdapter extends CustomAdapter {
    projectUnit project = null;
    public pendingProjectAdapter(Activity a, ArrayList d, Resources resLocal){
        super(a,d,resLocal);
    }
    ...
    protected class OnItemClickListener  implements View.OnClickListener{
        ...
        public void onClick(View arg0) {
            devPendingMatches sct = (devPendingMatches)activity;
