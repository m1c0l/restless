...
public class devProjectViewAdapter extends CustomAdapter {
    projectUnit project = null;
    public devProjectViewAdapter(Activity a, ArrayList d, Resources resLocal){
        super(a,d,resLocal);
    }
    ...
    protected class OnItemClickListener  implements View.OnClickListener{
        ...
        public void onClick(View arg0) {
            devActiveProjects sct = (devActiveProjects)activity;
