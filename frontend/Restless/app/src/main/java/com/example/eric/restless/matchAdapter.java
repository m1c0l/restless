...
public class matchAdapter extends CustomAdapter {
    developerUnit tempTeam = null;
    public matchAdapter(Activity a, ArrayList d, Resources resLocal){
        super(a,d,resLocal);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            holder.teamName.setText("No matches");
    ...
    protected class OnItemClickListener  implements View.OnClickListener{
        ...
        public void onClick(View arg0) {
            manageMatchesPM sct = (manageMatchesPM)activity;
