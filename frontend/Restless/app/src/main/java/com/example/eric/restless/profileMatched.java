    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener{
        ...
        public boolean onFling(MotionEvent event1, MotionEvent event2,
            ...
            if(horizontal_move) {
                ...
                if (horizontal > 0) {
                    textflipper.setInAnimation(profileMatched.this, R.anim.in_from_left);
                    textflipper.setOutAnimation(profileMatched.this, R.anim.out_to_right);
                    textflipper.showPrevious();
                } else {

                    textflipper.setInAnimation(profileMatched.this, R.anim.in_from_right);
                    textflipper.setOutAnimation(profileMatched.this, R.anim.out_to_left);
